...
void MyApp::handleAreaSelect() {
  ...
  if (!m_screenshot_frame->IsBeingDeleted() &&
    ...
    if (!screeshot_taken) {
      ...
      // img.SaveFile("./test.png", wxBITMAP_TYPE_PNG); this is how you save an
      // image these are the coordinates that are going to be used to determine
      // wanted area of the screen
